...
const MENU_COMPLETO = [
  ...
  { id: 'baixagas', label: 'Baixa Automática Gás', icon: '🔥' },
  { id: 'vinculofrete', label: 'Vínculo NF × CT-e', icon: '🔗' },
      ...
      <main style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
        <header style={{
          ...
          <div>
            ...
            {dtIniISO && dtFimISO && !['fechamento', 'razao', 'historico', 'painel', 'sync', 'fluxocaixa', 'compfiscal', 'confiscal', 'rateio', 'auditoria', 'baixagas', 'vinculofrete', 'admin', 'reqalmox', 'automacoes'].includes(pagina) && (
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            {!['fechamento', 'razao', 'sync', 'fluxocaixa', 'compfiscal', 'confiscal', 'rateio', 'auditoria', 'baixagas', 'vinculofrete', 'admin', 'reqalmox', 'automacoes'].includes(pagina) && (
              <SeletorPeriodo
            ...
            {pagina !== 'rateio' && pagina !== 'auditoria' && pagina !== 'baixagas' && pagina !== 'vinculofrete' && pagina !== 'admin' && pagina !== 'reqalmox' && pagina !== 'automacoes' && (
