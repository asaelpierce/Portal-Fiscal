...
export const PAGINAS = [
  ...
  { id:'automacoes', label:'Controle de Automações' }, { id:'processos', label:'Processos & Economia' }, { id:'modulos', label:'Módulos e Telas' }, { id:'demandas', label:'Demandas' }, { id:'admin', label:'Administração' },
]
